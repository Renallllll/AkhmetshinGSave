...
namespace AkhmetshinGSave
{
    ...
    public partial class AkhmetshinGSaveEntities : DbContext
    {
        public static AkhmetshinGSaveEntities _context;

        public static AkhmetshinGSaveEntities GetContext()
        {
            if ( _context == null )
                _context = new AkhmetshinGSaveEntities();   
            return _context;
        }
        public AkhmetshinGSaveEntities()
            : base("name=AkhmetshinGSaveEntities")
        {
        }
